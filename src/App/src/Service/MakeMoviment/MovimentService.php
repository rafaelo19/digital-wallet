...
class MovimentService
{
                                ...
                                array $typesMoviment)
    {
        ...
        $this->typesMoviment = $typesMoviment;
    }
    ...
    public function updateAccount():void
    {
        ...
        if ($this->movimentDto->getIdTipoMovimento() == $this->typesMoviment['dep']) {
    ...
    private function insertMoviment(): void
    {
        ...
        if ($this->movimentDto->getIdTipoMovimento() == $this->typesMoviment['trs']) {
